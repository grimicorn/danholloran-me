...
A while ago I wrote a post on [Setting Up Your Shell](/setting-up-your-shell). I wanted to follow up with more information about ZShell and OHMyZSH. Since both have really made using the terminal a lot easier and more enjoyable. So check out [Setting Up Your Shell](/setting-up-your-shell) to get up to speed. This will be a very high overview of configuring ZSHell and OHMyZSH.
