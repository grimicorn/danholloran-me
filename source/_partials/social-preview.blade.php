...
<div class="social-preview sp-twitter">
    ...
    <div class="flex items-center text-twitter flex items-center px-6 py-2 mt-2">
        <a href="{{ $page->instagram->get('link') }}" class="mr-auto h-8 flex items-center">
...
<div class="social-preview sp-instagram relative">
    <div class="sp-instagram-content">
        {!! $item->getContent() !!}
    </div>
    <div
        ...
        <a href="{{ $page->twitter->get('link') }}" class="mr-auto h-8 flex items-center text-instagram">
            @include('_partials.icon-instagram')
        </a>
        <a href="{{ $page->instagram->get('link') }}" color="text-instagram">
...
<div class="social-preview sp-youtube relative">
    <img src="https://img.youtube.com/vi/{{  $item->id  }}/0.jpg" alt="{{ $item->title }} thumbnail" class="object-fit">
    <div class="absolute px-6 py-2 w-full bg-white bottom-0 left-0 flex items-center  bg-white flex items-center">
        <a href="{{ $page->youTube->get('link') }}" class="mr-auto h-8 flex items-center">
            @include('_partials.icon-youtube')
        </a>
        <a href="{{ $page->youTube->get('link') }}" color="text-youtube">
