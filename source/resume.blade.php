...
@section('body')
    <div class="container mx-auto max-w-6xl justify-end flex mb-8 print-hidden bg-gray-100 px-8 py-4 -mt-8">
        <a
    ...
    <div class="flex container max-w-6xl mx-auto resume">
        <div class="bg-gray-100 px-8 py-12 w-1/3">
            <div class="mb-8">
                <h1 class="leading-none text-2xl mb-1">Dan Holloran</h1>
                <h2 class="text-indigo-500 leading-none mb-0 mt-0 text-lg">Senior Full Stack Developer</h2>
            </div>
            <div class="mb-8">
