        ...
        <div class="container flex max-w-6xl mx-auto bg-white resume">
            <div class="w-1/3 px-8 py-12 bg-gray-100">
                <div class="mb-8">
                    ...
                    <h2 class="mt-0 mb-0 text-lg leading-none text-indigo-500">Full Stack Developer</h2>
                </div>
                <div class="mb-8">
                    ...
                    <ul class="my-0">
                        ...
                        <li class="flex items-center">
                            <span class="block w-4 h-4 mr-2 text-gray-500">@include('_partials.icon-phone')</span> <span class="sr-only">Phone:</span> 314-368-5819
                        </li>
                ...
                <div class="mb-8">
                    ...
                    <ul class="flex flex-wrap -mx-1">
                        @foreach ($skills->reject(function($item) {
                            ...
                            <li class="inline-block px-3 pt-px mb-2 mr-2 text-xs font-semibold leading-loose tracking-wide text-gray-800 bg-gray-300 rounded">
                                {{ $item->title }}
                            </li>
                        @endforeach
                    </ul>
                ...
                <div class="pb-4 mb-8 border-b-2">
                    ...
                    @foreach ($experience->whereNotIn('category', ['education'])->reject(function($item) {
                        ...
                        <div class="mb-4">
                            ...
                            <h4 class="mt-0 mb-0 text-lg text-indigo-500">
