...
<template>
  ...
  >
    <div class="max-w-max-w-170 w-full text-center">
      ...
      <div
        class="reveal mountain-float mb-6 flex justify-center"
      ...
      >
        ...
        >
          <!-- Sun/moon disc -->
          <circle cx="140" cy="30" r="12" fill="#ad46ff" opacity="0.25" />
          <circle cx="140" cy="30" r="6" fill="#ad46ff" />
          <!-- Back ridge -->
          <path
            d="M0 88 L40 50 L70 70 L110 38 L150 65 L180 55 L180 92 L0 92 Z"
            fill="#111110"
            opacity="0.18"
          />
          <!-- Mid ridge -->
          <path
            d="M-10 92 L25 60 L55 78 L90 50 L130 75 L165 65 L185 78 L185 95 L-10 95 Z"
            fill="#ad46ff"
            opacity="0.6"
          />
          <!-- Front peak with snow cap -->
          <path
            d="M20 95 L60 35 L100 95 Z"
            fill="#111110"
            class="dark-flip-fill"
          />
          <path
            d="M52 50 L60 35 L68 50 L65 47 L60 52 L55 47 Z"
            fill="#ffffff"
          />
          <!-- Second peak -->
          <path d="M75 95 L110 50 L145 95 Z" fill="#ad46ff" />
          <path
            d="M104 60 L110 50 L116 60 L114 58 L110 62 L106 58 Z"
            fill="#ffffff"
          />
          <!-- baseline -->
          <path
          ...
          <line
            ...
            class="dark-flip-stroke"
          />
          <path d="M60 20 L70 24 L60 28 Z" fill="#ad46ff" />
        </svg>
      </div>

      <!-- Big 404 -->
      <h1
        class="reveal glitch mb-6 font-mono leading-none font-bold select-none"
        style="
        ...
        "
      >
        <span class="text-outline">404</span>
      </h1>

      <!-- Headline -->
      <h2
        class="reveal mb-5 font-mono leading-[1.15] font-bold"
        style="
      ...
      >
        ...
        someone's browser bar. No big deal — pick a trail below and you'll be
        back on solid ground.
      </p>

      <!-- Actions -->
      <div
        class="reveal mb-14 flex flex-wrap justify-center gap-3"
      ...
      <div class="reveal" style="transition-delay: 440ms">
        ...
        <div class="mx-auto grid max-w-140 grid-cols-2 gap-3 md:grid-cols-4">
          ...
          >
            ...
            <div class="text-fg font-mono text-[0.78rem] font-semibold">
              projects
            </div>
