...
<template>
  ...
  <Teleport to="body">
    <div
      class="absolute top-0 bottom-0 left-0 right-0 h-full w-full bg-gradient text-white z-30 transition-all px-8 p-16 ease-in-out duration-300"
      :class="{
    ...
    >
      ...
      <button
        ...
        @click="toggleIsOpen"
        v-show="isOpen"
        class="text-pink-500 absolute right-0 top-0 mt-4 mr-4"
      >
